...
'git reset имя_коммита/имя_тэга' — отменить все коммиты после указанного коммита, изменения будут сохранены локально.

`git reset --hard имя_коммита` – принудительно вернутся к указанному коммиту, не сохраняя историю и изменения
...
`git checkout имя_файла` — вернуть файл в первоначальное состояние если он еще не был добавлен в индекс коммита

`git checkout -b имя_ветки` – переключиться на указанную удаленную ветку

`git branch -a` — посмотреть полный список локальных и удаленных веток

`git branch -d имя_ветки` – удалить ветку

`git branch -D имя_ветки` — принудительно удалить заданную ветку, игнорируя ошибки
